    ...
    class ProductSeed : IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, Name = "Kareli Defter", Price = 19.50m, Stock = 425, CategoryId = _categoryIdList[1] },
                new Product { Id = 4, Name = "Çizgisiz Defter", Price = 17.25m, Stock = 325, CategoryId = _categoryIdList[1] }
                );
        }
    }
}
